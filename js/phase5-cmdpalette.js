...
(function() {
    ...
    const CommandPalette = {
        ...
        commands: [
            ...
            { id: 'action-agent-atlas', icon: '💼', title: 'Switch to Atlas', desc: 'Switch to operations agent', category: 'Actions', shortcut: 'A C', action: () => switchToAgent('atlas') },
    ...
    function switchToAgent(agent) {
        if (typeof switchToSession === 'function') {
            ...
            showToast(`Switched to ${canonicalAgent.toUpperCase()} agent`, 'success');
        }
    }
